...
def test_viz_class_path():
    ...
    observed = core.viz.viz_class_path(class_for_test, dir_for_test_path)
...
def test_viz_class_location():
    ...
    observed = core.viz.viz_class_location(known_point, crs=known_crs, buffer=50)
...
def test_plot_movie():
    ...
    center = core.viz.viz_class_location(mypoint, orig_crs)
    ...
    fpath_class = core.viz.viz_class_path(_myclass, fpath_pack)
    ...
    # make video
    core.viz.viz_class_video(fpath_class)
